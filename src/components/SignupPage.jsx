        ...
        <div className='flex md:flex-row flex-col justify-evenly rounded-xl md:rounded-none px-6 md:px-16 w-[90vw] md:w-[60vw] h-auto md:h-[65vh] py-6 md:py-18 backdrop-blur-3xl shadow-xl'>
          ...
          <div className='flex flex-col justify-center items-center gap-4'>
            ...
            <div className="relative w-full md:w-[22vw] lg:w-[18vw]">
              <input type={showPassword ? "text" : "password"} placeholder="Enter Password" className="border-b p-2.5 text-lg w-[75vw] md:w-[18vw] text-start transition duration-300 ease-in-out focus:ring-2 focus:ring-blue-400"/>
            ...
            <div className="relative w-full md:w-[22vw] lg:w-[18vw]">
              <input type={showPassword ? "text" : "password"} placeholder="Confirm Password" className="border-b p-2.5 text-lg w-[75vw] md:w-[18vw] text-start transition duration-300 ease-in-out focus:ring-2 focus:ring-blue-400"/>
              <button type="button" className="absolute right-0 top-2 text-sm text-black" onClick={() => setShowPassword(prev => !prev)}>{showPassword ? <EyeClosed/> : <Eye/>}</button>
            </div>
