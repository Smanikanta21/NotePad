...
const Nav = () => {
  ...
  return (
    <div className='flex flex-row justify-center items-center mt-4 fixed top-0 left-0 right-0'>
      <div className={`md:flex backdrop-blur-sm text-2xl font-medium items-center w-full max-w-6xl flex-row md:items-center md:justify-center z-10 md:text-3xl px-4 py-1 rounded-3xl shadow-2xl bg-transparent`}>
