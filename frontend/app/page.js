"use client"
import { Notebook, LucideMenu, X } from "lucide-react";
    ...
    <>
      <div className="relative min-h-screen">
        <div className="absolute inset-0 z-0">
          <img src={'/bg-assets.jpg'} alt="" className="absolute -top-24 -left-20 md:-top-36 md:-left-56 w-[70%] md:w-[60%] lg:w-[50%] -scale-x-100 object-cover pointer-events-none opacity-90 blur-2xl transform-gpu" />
        </div>
          ...
          <div className="fixed top-0 left-0 w-full z-30 backdrop-blur-sm shadow-md border-b border-white/20 pb-1">
            <nav className="flex md:ml-11 w-full md:w-11/12 gap-4 md:gap-7 pt-6 md:justify-around md:pt-2 flex-row items-center">
              ...
              <div className="flex gap-5 flex-col w-full md:w-auto justify-center items-center">
                ...
                <div className="md:hidden flex flex-col items-center justify-center overflow-hidden transition-all duration-300 ease-in-out">
                  <div className={`flex flex-col gap-4 text-lg font-semibold text-gray-800 transform transition-all duration-300 ease-in-out ${menu ? 'scale-100 opacity-100 max-h-40' : 'scale-95 opacity-0 max-h-0'}`}>
              ...
              <div className="hidden md:block hover:shadow-2xl hover:scale-105 transition duration-300 items-center p-3 text-white rounded-xl bg-blue-600">
                <Link className="text-md" href="/login">Get Started</Link>
              </div>
            </nav>
          </div>
          <div className="flex md:flex-row gap-6 flex-col md:gap-0 justify-center items-center h-screen text-center">
            <h1 className="px-6 mt-0 text-5xl md:text-8xl font-extrabold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500">
            ...
            <div className="block md:hidden items-center p-3 text-white rounded-xl bg-blue-600">
              <Link className="text-xl " href="/login">Get Started</Link>
            </div>
          </div>
          ...
          <section id="Contact" className="w-full px-6 py-16 md:py-24">
            <div className="max-w-6xl mx-auto bg-indigo-50 rounded-[3rem] p-10 md:p-16 shadow-xl relative overflow-hidden" style={{ backgroundImage: 'url(https://keynote.tailwindui.com/_next/static/media/background-newsletter.488a0204.jpg)', backgroundSize: 'cover', backgroundPosition: 'center top -80px' }}>
              ...
              <div className="md:flex hidden justify-center w-full md:h-[60vh] py-20 ">
                <div className="w-[80vw] h-full bg-cover gap-48 bg-center rounded-br-full flex justify-evenly pr-10 items-center rounded-tr-full" style={{ backgroundImage: `url('/bg-assets.jpg')`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center top -280px', width: '80vw' }} >
                  <div className="flex gap-4 px-8 flex-col">
                    ...
                    <div className="flex justify-center gap-4">
                      <div className="transition-transform hover:scale-110 flex justify-center items-center flex-col"><a href="https://www.instagram.com/abhi._.nay"><img src={'/insta.png'} alt="Instagram" className="rounded-lg w-10 h-10 cursor-pointer" /></a><p className="hidden hover:flex">Instagram</p></div>
                      <a href="https://github.com/Smanikanta21"><img src={'/github.png'} alt="GitHub" className="rounded-lg w-10 h-10 hover:scale-120 cursor-pointer transition-transform" /></a>
                      <a href=""><img src={'/linkedin.png'} alt="LinkedIn" className="rounded-lg w-10 h-10 hover:scale-120 cursor-pointer transition-transform" /></a>
                    </div>
                  </div>
              ...
              <div className="md:hidden py-20 flex justify-center items-center ">
                <div className="flex flex-col w-11/12 max-w-md gap-6 p-6 rounded-xl shadow-lg border border-gray-200 text-center">
                  ...
                  <div className="flex justify-center gap-4">
                    <a href="https://www.instagram.com/abhi._.nay"><img src={'/insta.png'} alt="Instagram" className="rounded-lg w-10 h-10 hover:scale-120 cursor-pointer transition-transform" /></a>
                    <a href="https://github.com/Smanikanta21"><img src={'/github.png'} alt="GitHub" className="rounded-lg w-10 h-10 hover:scale-120 cursor-pointer transition-transform" /></a>
                    <a href=""><img src={'/linkedin.png'} alt="LinkedIn" className="rounded-lg w-10 h-10 hover:scale-120 cursor-pointer transition-transform" /></a>
                  </div>
                </div>
